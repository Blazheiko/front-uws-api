...
const store = useApiRoutesStore()
const { httpRoutes, wsRoutes } = storeToRefs(store)

//icon: 'pi pi-fw pi-bookmark',

const menuHttpRoutes = computed(() => httpRoutes.value
...
const menuWsRoutes = computed(() => wsRoutes.value
    .filter((route) => !!route.group)
    .map((route) => ({
  label: route.prefix,
  icon: 'pi pi-fw pi-bookmark',
...
const model = ref([
    {
        ...
        items: menuHttpRoutes.value
    },
    {
        label: 'WS',
        items: menuWsRoutes.value
        // items: [
